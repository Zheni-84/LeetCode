...
|  104 |                 Maximum Depth of Binary Tree                 |                   Tree, DFS, BFS                   |            [Java Code](src/main/java/easy/done/MaximumDepthOfBinaryTree.java)             |
|  110 |                     Balanced Binary Tree                     |                     Tree, DFS                      |      [Java Code](src/main/java/easy/done/OfficialSolutionForBalancedBinaryTree.java)      |
|  111 |                 Minimum Depth of Binary Tree                 |                   Tree, BFS, DFS                   |            [Java Code](src/main/java/easy/done/MinimumDepthOfBinaryTree.java)             |
|  112 |                           Path Sum                           |                   Tree, DFS, BFS                   |                     [Java Code](src/main/java/easy/done/PathSum.java)                     |
...
|  441 |                       Arranging Coins                        |                Math, Binary Search                 |                 [Java Code](src/main/java/easy/done/ArrangingCoins.java)                  |
...
|  572 |                   Subtree of Another Tree                    |                      BST, DFS                      |              [Java Code](src/main/java/easy/done/SubtreeOfAnotherTree.java)               |
...
|  637 |               Average of Levels in Binary Tree               |                 BST, DFS, In-order                 |           [Java Code](src/main/java/easy/done/AverageOfLevelsInBinaryTree.java)           |
|  653 |                 Two Sum IV - Input is a BST                  |               BST, DFS, Two-Pointer                |                    [Java Code](src/main/java/easy/done/TwoSumIV.java)                     |
...
|  744 |           Find Smallest Letter Greater Than Target           |                Binary Search, Array                |       [Java Code](src/main/java/easy/done/FindSmallestLetterGreaterThanTarget.java)       |
...
| 1351 |          Count Negative Numbers in a Sorted Matrix           |                Array, Binary Search                |       [Java Code](src/main/java/easy/done/CountNegativeNumbersInSortedMatrix.java)        |
...
| 1971 |                 Find if Path Exists in Graph                 |                 Graph, Union-Find                  |             [Java Code](src/main/java/easy/done/FindIfPathExistsInGraph.java)             |
...
| 2335 |             Minimum Amount of Time to Fill Cups              |                Array, Greedy, Heap                 |          [Java Code](src/main/java/easy/done/MinimumAmountOfTimeToFillCups.java)          |
| 2357 |         Make Array Zero by Subtracting Equal Amounts         |             Array, Hash Table, Sorting             |     [Java Code](src/main/java/easy/done/MakeArrayZeroBySubtractingEqualAmounts.java)      |
